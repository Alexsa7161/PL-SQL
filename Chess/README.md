...
1. « » — пустое белое поле, «.» — пустое черное поле;
2. «P» — белая пешка, «p» — черная пешка;
3. «N» — белый конь, «n» — черный конь;
4. «B» — белый слон, «b» — черный слон;
5. «R» — белая ладья, «r» — черная ладья;
6. «Q» — белый ферзь, «q» — черный ферзь;
7. «K» — белый король, «k» — черный король. 
<br>Запрос должен вывести два столбца:
1. 	line — номер горизонтали от 1 до 8;
2. 	chess — восемь символов данной горизонтали, от a до h.
